...
using DotNetNuke.Professional.Analytics.Components.Contracts;
using DotNetNuke.Web.Api;
using RootPosition.Analytics.Models;
using RootPosition.Infrastructure.Collections;

namespace DotNetNuke.Professional.Analytics.Services
{
    public class AnalyticsServiceController : DnnApiController
    {
        [HttpGet]
        public HttpResponseMessage GetStatsData(string startDate, string endDate)
        {
            var response = new
            {
                Success = true,
        ...
        [HttpGet]
        public HttpResponseMessage GetGraphData(string startDate, string endDate, int scale)
        {
            var response = new
            {
                Success = true,
        ...
        [HttpGet]
        public HttpResponseMessage GetMapData(string country = "")
        {
            var response = new
            {
                Success = true,
        ...
        [HttpGet]
        public HttpResponseMessage GetChoroplethData(string country = "")
        {
            var response = new
            {
                Success = true,
        ...
        private string GetMapDataInternal(string country)
        {
            ...
            try
            {
                ...
                var file = HttpContext.Current.Server.MapPath("/DesktopModules/DNNCorp/Analytics/ClientScripts/" + fileName);
