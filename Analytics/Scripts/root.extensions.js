...
root.Enum = function (keyValuePairs) {
...
root.Enum.prototype.getEnumName = function(enumValue) {
...
root.SortOrder = new root.Enum([{ key: 0, value: "unspecified" }, { key: 1, value: "ascending" }, { key: 2, value: "descending" }]);

root.executeFunctionByName = function(functionName, context /*, args */) {
...
root.singletonify = function(constructorFunc /*, args */) {
    var instance = null;
...
(function ($, window, document, undefined) {
    ...
    KeyValueConverter.arrayToDictionary = function (pairs, keyProp, valProp) {
        var dictionary = new root.Dictionary();
