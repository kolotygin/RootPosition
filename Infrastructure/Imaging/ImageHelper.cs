...
namespace Infrastructure.Imaging
{
    ...
    public static class ImageHelper
    {
        ...
        /// </summary>
        /// <param name="physicalPath">The physical path of the image to get the dimensions of.</param>
        /// <returns>The dimensions of the specified image.</returns>
        /// <exception cref="ArgumentException">The image was of an unrecognised format.</exception>
        public static Size GetDimensions(string physicalPath)
        {
            Size size;
            try
            {
                using (var binaryReader = new BinaryReader(File.OpenRead(physicalPath)))
                {
                    try
                    {
                    ...
                    {
                        var newMessage = string.Format("{0} file: '{1}' ", ErrorMessage, physicalPath);
                        throw new ArgumentException(newMessage, "physicalPath", e);
                    }
                }
            }
            catch (ArgumentException)
            {
                ...
                using (var b = new Bitmap(physicalPath))
                {
                    size = b.Size;
                }
            }
        ...
        ///     Gets the dimensions of an image.
        /// </summary>
        /// <param name="binaryReader">The physicalPath of the image to get the dimensions of.</param>
        /// <returns>The dimensions of the specified image.</returns>
        /// <exception cref="ArgumentException">The image was of an unrecognised format.</exception>
